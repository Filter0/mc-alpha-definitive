...
public class GuiMainMenu extends GuiScreen {
	...
	public void initGui() {
		...
		this.controlList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 48, "Singleplayer"));
		this.controlList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 72, "Multiplayer"));
		this.controlList.add(new GuiButton(2, this.width / 2 - 100, this.height / 4 + 96, "Options"));
	...
	public void drawScreen(int mouseX, int mouseY, float renderPartialTick) {
		...
		GL11.glPopMatrix();
		String string6 = "Revision 1.0.0, built on 1/30/23";
	...
	private void drawLogo(float renderPartialTick) {
		...
		i3 = 100 * scaledResolution14.scaleFactor;
