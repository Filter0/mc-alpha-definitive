...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float renderPartialTick, boolean hasScreen, int width, int height) {
		...
		if(Keyboard.isKeyDown(Keyboard.KEY_F3)) {
			fontRenderer8.drawStringWithShadow("MC Alpha Definitive v1.0.0 (" + this.mc.debug + ")", 2, 2, 0xFFFFFF);
			...
			fontRenderer8.drawStringWithShadow("MC Alpha Definitive v1.0.0", 2, 2, 0xFFFFFF);
		}
