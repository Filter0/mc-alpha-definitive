...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public Chunk provideChunk(int x, int z) {
		...
		Chunk chunk4 = new Chunk(this.worldObj, b3, x, z);
		this.generateTerrain(x, z, b3);
		this.replaceSurfaceBlocks(x, z, b3);
		this.caveGenerator.generate(this, this.worldObj, x, z, b3);
	...
	public void populate(IChunkProvider chunkProvider, int x, int z) {
		...
		this.rand.setSeed((long)x * j6 + (long)z * j8 ^ this.worldObj.randomSeed);
		double d10 = 0.25D;
