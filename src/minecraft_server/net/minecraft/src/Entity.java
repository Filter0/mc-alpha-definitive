...
public abstract class Entity {
	...
	public void moveEntity(double x, double y, double z) {
		if(this.noClip) {
			...
			boolean z36 = this.onGround || d13 != y && d13 < 0.0D;
			...
			int i28;
			double d37;
			if(this.stepHeight > 0.0F && z36 && this.ySize < 0.05F && (d11 != x || d15 != z)) {
				d37 = x;
				d23 = y;
				double d25 = z;
				x = d11;
				...
				list35 = this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox.addCoord(d11, y, d15));

				for(i28 = 0; i28 < list35.size(); ++i28) {
					y = ((AxisAlignedBB)list35.get(i28)).calculateYOffset(this.boundingBox, y);
				}
				...
				for(i28 = 0; i28 < list35.size(); ++i28) {
					x = ((AxisAlignedBB)list35.get(i28)).calculateXOffset(this.boundingBox, x);
				}
				...
				for(i28 = 0; i28 < list35.size(); ++i28) {
					z = ((AxisAlignedBB)list35.get(i28)).calculateZOffset(this.boundingBox, z);
				}
			...
			if(this.canTriggerWalking && !z18) {
				...
				if(this.distanceWalkedModified > (float)this.nextStepDistance && i28 > 0) {
					...
					if(this.worldObj.getBlockId(i38, i26 + 1, i40) == Block.snow.blockID) {
					...
					} else if(!Block.blocksList[i28].material.getIsLiquid()) {
						this.worldObj.playSoundAtEntity(this, stepSound29.getStepSound(), stepSound29.getVolume() * 0.15F, stepSound29.getPitch());
					}
			...
			int i41 = MathHelper.floor_double(this.boundingBox.maxY);
			int i30 = MathHelper.floor_double(this.boundingBox.maxZ);

			for(int i31 = i38; i31 <= i28; ++i31) {
				for(int i32 = i26; i32 <= i41; ++i32) {
					for(int i33 = i40; i33 <= i30; ++i33) {
