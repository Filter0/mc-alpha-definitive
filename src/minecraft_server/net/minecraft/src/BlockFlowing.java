	...
	private int calculateFlowCost(World world, int x, int y, int z, int i5, int i6) {
		...
		for(int i8 = 0; i8 < 4; ++i8) {
			if((i8 != 0 || i6 != 1) && (i8 != 1 || i6 != 0) && (i8 != 2 || i6 != 3) && (i8 != 3 || i6 != 2)) {
				...
				if(!this.blockBlocksFlow(world, i9, y, i11) && (world.getBlockMaterial(i9, y, i11) != this.material || world.getBlockMetadata(i9, y, i11) != 0)) {
					if(!this.blockBlocksFlow(world, i9, y - 1, i11)) {
						return i5;
					}
