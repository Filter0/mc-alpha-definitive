...
public class ItemInWorldManager {
	...
	public void onBlockClicked(int i1, int i2, int i3) {
		...
		if(i4 > 0 && this.removeProgress == 0.0F) {
			Block.blocksList[i4].onBlockClicked(this.worldObj, i1, i2, i3, this.thisPlayer);
		}
	...
	public boolean removeBlock(int i1, int i2, int i3) {
		Block block4 = Block.blocksList[this.worldObj.getBlockId(i1, i2, i3)];
	...
	public boolean tryHarvestBlock(int i1, int i2, int i3) {
		...
		if(z6 && this.thisPlayer.canHarvestBlock(Block.blocksList[i4])) {
			Block.blocksList[i4].dropBlockAsItem(this.worldObj, i1, i2, i3, i5);
		}
